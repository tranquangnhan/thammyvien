                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" id="formlogin" data-parsley-validate novalidate> 
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="user" name="taikhoan" id="user" required  placeholder="Tài Khoản">
                                       
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="password">Mật Khẩu</label>
                                        <input class="form-control" type="password" name="password" required id="password" placeholder="Mật Khẩu">
                                    </div>
                                    <div class="form-group mb-3">
                                    <?php
